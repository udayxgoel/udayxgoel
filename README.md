...
const uday = {
  name: "Uday Goel",
  location: "India 🇮🇳",
  education: "Computer Science (MCA)",
  portfolio: "https://udaygoel.dev",
  contact: "dev.udaygoel@gmail.com",
  askMeAbout: ["Next.js", "React", "TypeScript", "Node.js"],
